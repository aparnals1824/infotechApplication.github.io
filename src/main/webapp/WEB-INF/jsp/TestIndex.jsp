            ...
            <c:if test="${user_id != null}">
                ...
                <div class="col-md-12" style="margin-top: 2%;width: 87%; margin-left: 7%;">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="col-md-4">
                                 Invoice No: <input readonly="1" name="invoice_no" type="text" class="form-control" ng-model="oid = ${orderNo}" value="${orderNo}" />
...
<!--                                          <input readonly="1" name="orderQty" value="{{clickedProduct.qty}}" type="text" class="form-control" id="qty" placeholder="Enter Quantity">
 -->
                ...
                <div id="cart" class="col-md-12" style="text-align: center; margin-top:23%;width: 87%; margin-left: 7%;">
                    ...
                    <div class="modal-content">
                       ...
                       <td> ₹
                        ...
                        <div class="modal-footer">
                            <button  data-toggle="modal" type="button" onclick="printDiv('invoice')" class="btn btn-warning" ><i class="fa fa-print"></i> Print</button>
...
<!--     <button onclick="Close()" id="close">X</button>
 -->
    ...
    <div class="invoice overflow-auto" style="height: 200%;
    margin-top: -2%;
    width: 89%;
    margin-left: 6%;">
        ...
        <div style="min-width: 600px">
            <header>
                ...
                <div class="row">
                    ...
                    <div class="col company-details" style="margin-left: 2%;">
                        <h2 class="name">
<!--                             <a target="_blank" href="https://lobianijs.com">
 -->                        
                            <a> INFOTECH ASSOCIATES
                            </a>
                        </h2>
                        ...
                        <!-- <div>9207170300</div>
                        <div>infotechkoz@gmail.com</div> -->
                        
                     <table  align="right" style="width: 62%; border: none;margin-top: -10%;">
                    <tbody>
                        <tr><td style="text-align: left;padding:5px;background: #fff;border-bottom: 1px solid #fff">Delivery Note : </td>
                        <td style="text-align: left;padding: 5px;background: #fff;border-bottom: 1px solid #fff">Mode of Payment :</td></tr>
                        <tr> <td style="text-align: left;padding: 5px;background: #fff;border-bottom: 1px solid #fff">Suppliers Ref :</td> </tr>
                                        
                        <tr><td style="text-align: left;padding: 5px;background: #fff;border-bottom: 1px solid #fff">Other Ref :</td>
                        </tr>
                        <tr>  <td style="text-align: left;padding: 5px;background: #fff;border-bottom: 1px solid #fff">Buyers Order No:</td>
                              <td style="text-align: left;padding:5px;background: #fff;border-bottom: 1px solid #fff">Dated :</td>
                        </tr>
                          <tr>  <td style="text-align: left;padding: 5px;background: #fff;border-bottom: 1px solid #fff">Despatch Doc No :</td> 
                                <td style="text-align: left;padding: 5px;background: #fff;border-bottom: 1px solid #fff">Delivery Note Date :</td> 
                          </tr>
                          <tr> <td style="text-align: left;padding: 5px;background: #fff;border-bottom: 1px solid #fff">Despatched Through :</td></tr>
                           <tr> <td style="text-align: left;padding: 5px;background: #fff;border-bottom: 1px solid #fff">Terms of Delivery :</td>
                                 <td style="text-align: left;padding: 5px;background: #fff;border-bottom: 1px solid #fff">Destination :</td>
                            </tr>
